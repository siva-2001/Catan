...
public class GameField : MonoBehaviour
{
    ...
    [SerializeField] private bool constructionIsPossible = false;
    [SerializeField] private bool roadConstructionIsPossible = false;
    [SerializeField] private bool robbersCanMoves = false;
        ...
        foreach(GameObject place in buildPlaces){
            ...
            foreach(GameObject _road in roadPlaces){
                if(_road.GetComponent<RoadScript>().GetBuildPlace1() == place.GetComponent<BuildPlaceScript>().GetPlaceNumber() &&
                    _road.GetComponent<RoadScript>().GetRoadExisting()){
